...
/* Initalize the Ethernet network and packet processing */
// Returns true if everythnig initalized OK
bool packet_Init(void)
{
    printf("Initalizing network, using port %d\n", portno);
...
// It handles all of the socket connection stuff
