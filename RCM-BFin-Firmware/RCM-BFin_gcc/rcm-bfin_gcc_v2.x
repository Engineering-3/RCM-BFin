...
MEMORY
{
  ...
  MEM_SDRAM_STACK : ORIGIN = 0x00200000, LENGTH = 1 * 1024 * 512
  MEM_SDRAM_HEAP  : ORIGIN = 0x00280000, LENGTH = 1 * 1024 * 512
}
...
SECTIONS
{
  ...
  __stack_end = ORIGIN(MEM_SDRAM_STACK) + LENGTH(MEM_SDRAM_STACK);
